...
public class GAMECPU extends AppCompatActivity implements View.OnClickListener {
    ...
    private void saveGame() {
        SharedPreferences sharedPreferences = getSharedPreferences("TicTacToeGame3", MODE_PRIVATE);
