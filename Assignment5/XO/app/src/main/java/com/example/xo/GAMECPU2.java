...
public class GAMECPU2 extends AppCompatActivity implements View.OnClickListener {
    ...
    private void cpumove() {
        ...
        int [] bestMove = ticTacToe.move(field);
        int R = bestMove[0];
        int C = bestMove[1];
        ...
        roundCount++;
        moveStack.push(buttons[R][C]); // Push the clicked button onto the stack
    ...
    private void saveGame() {
        SharedPreferences sharedPreferences = getSharedPreferences("TicTacToeGame4", MODE_PRIVATE);
